  ...
  "inline-flex items-center justify-center cursor-pointer transition-colors duration-200 outline-none disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        tag: "rounded-none bg-white/5 text-white/80 uppercase tracking-wider border border-white/20 hover:bg-white/10 hover:text-white hover:border-white/40 data-[state=checked]:bg-blood-red/15 data-[state=checked]:text-blood-red data-[state=checked]:border-blood-red/50",
      },
      size: {
        default: "",
